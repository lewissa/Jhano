...
/**
 * Esta clase permite realizar las transacionnes contra la base de datos sobre
...
public class cTransaccionFactura {
     ...
     *
     * @param strFactura, con tiene los parametros a ser ingrsado en los capos
     * de la tabla factura
     * @return Boolean, booResultado contiene el resultado de la aplicacion del
     * metodo
     */
