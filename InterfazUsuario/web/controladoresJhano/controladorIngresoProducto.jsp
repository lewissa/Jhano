<%-- 
    Document   : controladorIngresoProducto
    Created on : 20/05/2014, 09:29:48 PM
    Author     : eborja
--%>
        ...
        <%
            try {
                ...
                if (!(strDescripcionGeneral.equals("0") || strPrecioCosto.equals("0") || strMargenVenta.equals("0"))) {
                    booResultado = port.actualizaDataBaseProducto(proProducto);
                }
                ...
                if (port.getErrorConexionProducto() != null) {
                    ...
                    response.sendRedirect("../interfacesJhano/interfazIngresoProducto.jsp");
                }
            } catch (Exception e) {
